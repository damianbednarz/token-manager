// Auto-extracted from https://ui.bejamas.com/_astro/theme-tokens.*.js
// Snapshot taken 2026-05-07.
// Do not edit by hand; re-run the extractor in code.ts comments to refresh.
...
// Base themes have a full 32-key palette and can be applied directly.
export const BASE_THEMES: string[] = ['neutral','stone','zinc','mauve','olive','mist','taupe'];
